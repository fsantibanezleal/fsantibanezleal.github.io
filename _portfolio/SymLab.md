...
date: 2026-07-28
excerpt: "A public research lab on symbolic regression: recovering a readable closed-form expression from data. Its reason to exist is one distinction: accuracy and structural recovery are different claims, and a method can clear R2 above 0.999 while returning the wrong structure. SymLab reports the two separately, on every case, and never averages them into one number.<br/><img src='/images/projects/symlab_app.png'>"
collection: portfolio
tags: [scientific-ml, symbolic-regression, genetic-programming, sparse-regression, interpretability]
---
