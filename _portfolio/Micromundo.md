...
- **Team website**: [micromundo.team](https://micromundo.team)
- **Virtual microscopy app**: [micromundo.app](https://micromundo.app)
...
### 2017: Start-Up Chile
Micromundo Chile SpA was founded with [Start-Up Chile](https://www.startupchile.org/) seed funding from CORFO. The initial product: 3D-printed microscope kits with structured illumination, paired with educational content in optics and biology. Additional support from:
...
- **Super-resolution microscopy** ([SOFI project](/portfolio/SOFI_QDots/)) — the research that revealed the gap between professional and educational optics
- **Computational photography** ([Dual Photography](/portfolio/DualPhotography/)) — understanding light transport informs microscope design
