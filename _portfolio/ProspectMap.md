...
Negative controls collapse as they must: label permutation drops WofE to 0.506 and PU to 0.490, and a pure noise layer earns zero lift. The split-conformal band delivers its coverage guarantee (empirical 0.977 vs nominal 0.90), but only by flagging 88 percent of the belt, a near-vacuous set that correctly reports that regional geophysics cannot localize MVT under spatial transfer, rather than a false-confidence point map. This is target generation with its uncertainty stated, not a JORC or NI 43-101 resource estimate.
